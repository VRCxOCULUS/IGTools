...
namespace DAT1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Stream stream = File.Open("C:/Users/27alexander.smith_ca/Desktop/Personal/DAT1/DAT1/GameFiles/vanity_i30_advanced_suit.config", FileMode.Open);
            //BinaryReader br = new BinaryReader(stream);
            //DAT1 test = new DAT1(br);
        }
    }
}
